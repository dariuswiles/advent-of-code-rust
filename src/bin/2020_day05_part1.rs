...
//                 print!("Rear half of current range chosen. ");
            ...
            _ => {
                panic!("Unrecognized character in row selection of line {}", &line_num);
            }
        }
...
//                 print!("Right half of current range chosen. ");
            ...
            _ => {
                panic!("Unrecognized character in column selection of line {}", &line_num);
            }
        }
...
//     println!("Seat is in row {} and col {} with seat id {}", row, col, seat_id);

    Seat { row: row_limit_front, column: col_limit_left, seat_id: seat_id }
}
...
fn main() {
    ...
    println!("The highest seat ID present in the input data is {}", highest_seat_id);
}
...
mod tests {
    ...
    #[test]
    fn test_data_0() {
        assert_eq!(find_seat(0, "FBFBBFFRLR"), Seat{ row: 44, column: 5, seat_id: 357 });
    }

    #[test]
    fn test_data_1() {
        assert_eq!(find_seat(0, "BFFFBBFRRR"), Seat{ row: 70, column: 7, seat_id: 567 });
    }

    #[test]
    fn test_data_2() {
        assert_eq!(find_seat(0, "FFFBBBFRRR"), Seat{ row: 14, column: 7, seat_id: 119 });
    }

    #[test]
    fn test_data_3() {
        assert_eq!(find_seat(0, "BBFFBBFRLL"), Seat{ row: 102, column: 4, seat_id: 820 });
    }
}
