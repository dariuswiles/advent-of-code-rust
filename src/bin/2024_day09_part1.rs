...
//!
///
/// The input is a sequence of numbers represent files and empty space on disk blocks. The challenge
/// requires the disk blocks to be "compacted" by rearranging them so all the used blocks are
/// contiguous at the start of the disk. A checksum is then generated by summing a value
